<div class="col-md-12">	
	...
	<div style="margin-bottom:20px;margin-top:40px;" class="row">
		<form class="form-horizontal" action="<?php echo base_url(); ?>laporan_asset_rph/lihat_kartu_inventaris" method="post"/>
			<div class="col-sm-6">
				<table>
					<tr>
	...
	<div class="row">
		<div class="col-xs-12">
	 				...
	 				<center>
	          			<a style="margin-bottom:20px;" class="btn btn-primary btn-sm" onclick="exportKartuRph('xls');" href="javascript://"><span class="glyphicon glyphicon-export"> </span> Export to Excell</a>
	          		</center>
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
	<?php 
		if(!empty($kartu_inventaris)) {
		$no = 1;
		foreach($kartu_inventaris->result_array() as $data) {  ?>
							<tr>
								<td><?php echo $no; ?></td>
