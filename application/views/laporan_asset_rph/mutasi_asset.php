<div class="col-md-12">	
	...
	<div style="margin-bottom:20px;margin-top:40px;" class="row">
		<form class="form-horizontal" action="<?php echo base_url(); ?>laporan_asset_rph/lihat_mutasi_asset" method="post"/>
	<div class="col-sm-6">
	...
	<div class="row">
		<div class="col-xs-12">
	 				...
	 				<center>
	          			<a style="margin-bottom:20px;" class="btn btn-primary btn-sm" onclick="exportMutasiRph('xls');" href="javascript://"><span class="glyphicon glyphicon-export"> </span> Export to Excell</a>
	          		</center>
					...
					<table id="tblExport" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th style="background: #22313F;color:#fff;">Dari RPH</th>
								<th style="background: #22313F;color:#fff;">Pindah Ke RPH</th>
	...
	<?php 
		...
		foreach($mutasi_asset->result_array() as $data) {  ?>
							<tr>
								...
								<td><?php 
										$q_nama = $this->db->query("SELECT nama_rph FROM mst_rph WHERE id_rph = '$data[rph_penerima]'")->row();
										echo $q_nama->nama_rph; 
									?>		
								</td>
