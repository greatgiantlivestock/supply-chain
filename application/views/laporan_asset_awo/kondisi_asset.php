<div class="col-md-12">	
	...
	<div style="margin-bottom:20px;margin-top:40px;" class="row">
		<form class="form-horizontal" action="<?php echo base_url(); ?>laporan_asset_awo/lihat_kondisi_asset" method="post"/>
	<div class="col-sm-6">
	...
	<div class="row">
		<div class="col-xs-12">
	 				...
	 				<center>
	          			<a style="margin-bottom:20px;" class="btn btn-primary btn-sm" onclick="exportKondisiAwo('xls');" href="javascript://"><span class="glyphicon glyphicon-export"> </span> Export to Excell</a>
	          		</center>
