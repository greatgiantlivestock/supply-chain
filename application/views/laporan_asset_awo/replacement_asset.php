<div class="col-md-12">	
	...
	<div style="margin-bottom:20px;margin-top:40px;" class="row">
		<form class="form-horizontal" action="<?php echo base_url(); ?>laporan_asset_awo/lihat_replacement_asset" method="post"/>
	<div class="col-sm-6">
				<table class="tbl_input">
					...
					<tr>
						...
						<td>
							<select style="width:250px;" name="nama_awo" class="select_awo">
								<?php echo $combo_awo; ?>
							</select>
						</td>					
					</tr>			
	...
	<div class="row">
		<div class="col-xs-12">
	 				...
	 				<center>
	          			<a style="margin-bottom:20px;" class="btn btn-primary btn-sm" onclick="exportReplacementAwo('xls');" href="javascript://"><span class="glyphicon glyphicon-export"> </span> Export to Excell</a>
	          		</center>
